...
import { Terminal, Cpu, Github, Linkedin, CpuIcon, Check, CheckCircle2, ShieldAlert, Sparkles, X, HeartPulse } from "lucide-react";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const observerOptions = {
      root: null,
      rootMargin: "-25% 0px -40% 0px", // Trigger when element is well in the viewport
      threshold: 0,
    };
  ...
  // Trigger self healing animation sequence
  ...
  return (
    <div className={`relative min-h-screen bg-gray-950 font-sans text-gray-100 selection:bg-accent selection:text-gray-950 transition-colors duration-700 ${isChaosMode ? "shadow-[inset_0_0_100px_rgba(239,68,68,0.15)] border-red-500/10" : ""}`}>
      ...
      {/* High-fidelity SRE Auto-Healing Terminal Overlay Modal */}
      <AnimatePresence>
        {isHealing && (
